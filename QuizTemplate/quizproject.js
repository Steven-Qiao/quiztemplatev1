...
let downloadTimer = setInterval(
 ...
 function markIt(ans) {
	...
	//display score on webpage
		...
		message = "Congrats! you score is: " + score + " / " + questions.length;
...
{
	document.getElementById("question").innerHTML = questions[currentQuestion + 1].question;
    document.getElementById("a").innerHTML = "A. " + questions[currentQuestion + 1].a;
	document.getElementById("b").innerHTML = "B. " + questions[currentQuestion + 1].b;
	document.getElementById("c").innerHTML = "C. " + questions[currentQuestion + 1].c;
	document.getElementById("d").innerHTML = "D. " + questions[currentQuestion + 1].d;
	
	document.getElementById("image").innerHTML = questions[currentQuestion].image;
